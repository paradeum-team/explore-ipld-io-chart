...
![Version: 0.1.10](https://img.shields.io/badge/Version-0.1.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.1.21](https://img.shields.io/badge/AppVersion-v0.1.21-informational?style=flat-square)
...
```
helm install my-ipfs-cluster-extend paradeum-team/ipfs-cluster-extend --version 0.1.10
```
